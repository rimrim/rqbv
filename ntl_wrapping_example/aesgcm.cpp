...
extern "C"{
    ...
    TrungWrapper* Trungwrapper_new(){return new Trungwrapper();}
    int TrungWrapper_enc(Trungwrapper* t, unsigned char
                            *plaintext, int plaintext_len, unsigned
                            char *aad, int aad_len, unsigned char *key,
                            unsigned char *iv, unsigned char
                            *ciphertext, unsign char *tag){
        t->encrypt(plaintext, plaintext_len, aad, aad_len, key,
                    iv, ciphertext, tag);
    }
    int TrungWrapper_dec(TrungWrapper* t, unsigned char
        ...
        t->decrypt(ciphertext, ciphertext_len, aad, aad_len, tag,
                    key, iv, plaintext)
            }
}
